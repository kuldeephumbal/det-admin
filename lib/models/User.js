...
const userSchema = new mongoose.Schema(
  {
    ...
    // Normalized E.164 form of `phone` for split-expenses contact
    // matching. Additive: backfilled when a user sets a phone; existing
    // rows stay null and simply won't match until then. No existing
    // logic reads this field.
