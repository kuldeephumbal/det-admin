...
const userSchema = new mongoose.Schema(
  {
    ...
    // Google. Sparse-unique — only one row per Google account, and rows
    // without a value (pure email/password users) don't collide.
    googleSub: { type: String, default: null, sparse: true, index: true, unique: true },
    lastLoginAt: Date,
